...
public class VeranstaltungService implements Serializable{
	...
	private static final Logger log = Logger.getLogger(VeranstaltungService.class.getName());
    ...
    public List<Veranstaltung> getVeranstaltungsTipps(@PathParam("suchstring") String suchstring) {
        ...
        IMap<String, Veranstaltung> veranstaltungen = main.hazelcast.getMap("veranstaltungen");
        ...
        JobTracker jobTracker = main.hazelcast.getJobTracker("tippsJobTracker123");
